...
namespace render {
	...
	void draw_text_string_menu(int x, int y, unsigned long font, std::string string, bool text_centered, color colour);
	...
	void draw_filled_circle(int x, int y, float points, float radius, color col);
