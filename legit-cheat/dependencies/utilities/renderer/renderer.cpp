...
void render::initialize() 
{
	...
	interfaces::surface->set_font_glyph(render::fonts::menu_font, "Tahoma", 12, 500, 0, 0, font_flags::fontflag_dropshadow);
...
void render::draw_text_string_menu(int x, int y, unsigned long font, std::string string, bool text_centered, color colour) {
	const auto converted_text = std::wstring(string.begin(), string.end());
